...
gulp.task('test:clientruntime:java', shell.task('gradlew :client-runtime:build', { cwd: './', verbosity: 3 }));
gulp.task('test:clientruntime:javaazure', shell.task('gradle :azure-client-runtime:build', { cwd: './', verbosity: 3 }));
...
gulp.task('test:java', shell.task('gradlew :codegen-tests:build', {cwd: './', verbosity: 3}));
gulp.task('test:java:azure', shell.task('gradlew :azure-codegen-tests:build', {cwd: './', verbosity: 3}));
