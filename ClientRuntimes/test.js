var ps = require('./NodeJS/SwaggerPetstore');
var util = require('util');
var mc = require('./NodeJS/ClientRuntime/lib/common');

petstore = new ps.SwaggerPetstore("http://localhost:12510/api", new mc.TokenCloudCredentials({
