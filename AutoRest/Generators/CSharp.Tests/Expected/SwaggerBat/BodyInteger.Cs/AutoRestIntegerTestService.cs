namespace Fixtures.SwaggerBatBodyInteger
{
    ...
    /// </summary>
    public partial class AutoRestIntegerTestService : ServiceClient<AutoRestIntegerTestService>, IAutoRestIntegerTestService
    {
        /// <summary>
        ...
        /// </summary>
        public AutoRestIntegerTestService() : base()
        {
            this.Initialize();
        }
