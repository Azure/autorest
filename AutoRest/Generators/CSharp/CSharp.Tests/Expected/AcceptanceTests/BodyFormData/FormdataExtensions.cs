...
namespace Fixtures.AcceptanceTestsBodyFormData
{
    ...
    public static partial class FormdataExtensions
    {
            ...
            {
                HttpOperationResponse<UploadFile> result = await operations.UploadFileWithHttpMessagesAsync(fileContent, fileName, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
