...
namespace Fixtures.AcceptanceTestsBodyInteger
{
    ...
    public static partial class IntModelExtensions
    {
            ...
            {
                var result = await operations.GetOverflowInt32WithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.GetUnderflowInt32WithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.GetOverflowInt64WithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                var result = await operations.GetUnderflowInt64WithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
