namespace Fixtures.MirrorRecursiveTypes
{
    ...
    public static partial class RecursiveTypesAPIExtensions
    {
            ...
            {
                HttpOperationResponse<Product> result = await operations.PostWithOperationResponseAsync(subscriptionId, resourceGroupName, apiVersion, body, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
