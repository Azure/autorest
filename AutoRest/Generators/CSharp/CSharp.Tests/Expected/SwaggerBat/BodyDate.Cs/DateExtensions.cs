namespace Fixtures.SwaggerBatBodyDate
{
    ...
    public static partial class DateExtensions
    {
            ...
            {
                HttpOperationResponse<DateTime?> result = await operations.GetInvalidDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<DateTime?> result = await operations.GetOverflowDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<DateTime?> result = await operations.GetUnderflowDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutMaxDateWithOperationResponseAsync(dateBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<DateTime?> result = await operations.GetMaxDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutMinDateWithOperationResponseAsync(dateBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<DateTime?> result = await operations.GetMinDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
