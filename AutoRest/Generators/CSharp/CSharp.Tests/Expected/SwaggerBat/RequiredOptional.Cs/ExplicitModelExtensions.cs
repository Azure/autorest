namespace Fixtures.SwaggerBatRequiredOptional
{
    ...
    public static partial class ExplicitModelExtensions
    {
            ...
            {
                await operations.PostOptionalStringPropertyWithHttpMessagesAsync(bodyParameter, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostOptionalClassPropertyWithHttpMessagesAsync(bodyParameter, null, cancellationToken).ConfigureAwait(false);
            }
