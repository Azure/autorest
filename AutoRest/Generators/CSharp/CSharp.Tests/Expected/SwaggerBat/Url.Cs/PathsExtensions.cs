namespace Fixtures.SwaggerBatUrl
{
    ...
    public static partial class PathsExtensions
    {
            ...
            {
                await operations.GetBooleanTrueWithOperationResponseAsync(boolPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetBooleanFalseWithOperationResponseAsync(boolPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetIntOneMillionWithOperationResponseAsync(intPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetIntNegativeOneMillionWithOperationResponseAsync(intPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetTenBillionWithOperationResponseAsync(longPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetNegativeTenBillionWithOperationResponseAsync(longPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.FloatScientificPositiveWithOperationResponseAsync(floatPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.FloatScientificNegativeWithOperationResponseAsync(floatPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DoubleDecimalPositiveWithOperationResponseAsync(doublePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DoubleDecimalNegativeWithOperationResponseAsync(doublePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.StringUnicodeWithOperationResponseAsync(stringPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.StringUrlEncodedWithOperationResponseAsync(stringPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.StringEmptyWithOperationResponseAsync(stringPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.StringNullWithOperationResponseAsync(stringPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.EnumValidWithOperationResponseAsync(enumPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.EnumNullWithOperationResponseAsync(enumPath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.ByteMultiByteWithOperationResponseAsync(bytePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.ByteEmptyWithOperationResponseAsync(bytePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.ByteNullWithOperationResponseAsync(bytePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DateValidWithOperationResponseAsync(datePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DateNullWithOperationResponseAsync(datePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DateTimeValidWithOperationResponseAsync(dateTimePath, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DateTimeNullWithOperationResponseAsync(dateTimePath, null, cancellationToken).ConfigureAwait(false);
            }
