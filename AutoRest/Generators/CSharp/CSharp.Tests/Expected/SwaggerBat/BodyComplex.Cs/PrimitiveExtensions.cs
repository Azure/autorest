namespace Fixtures.SwaggerBatBodyComplex
{
    ...
    public static partial class PrimitiveExtensions
    {
            ...
            {
                HttpOperationResponse<IntWrapper> result = await operations.GetIntWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutIntWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<LongWrapper> result = await operations.GetLongWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutLongWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<FloatWrapper> result = await operations.GetFloatWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutFloatWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<DoubleWrapper> result = await operations.GetDoubleWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutDoubleWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<BooleanWrapper> result = await operations.GetBoolWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutBoolWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<StringWrapper> result = await operations.GetStringWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutStringWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<DateWrapper> result = await operations.GetDateWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutDateWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<DatetimeWrapper> result = await operations.GetDateTimeWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutDateTimeWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<ByteWrapper> result = await operations.GetByteWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutByteWithOperationResponseAsync(complexBody, cancellationToken).ConfigureAwait(false);
            }
