namespace Fixtures.SwaggerBatBodyBoolean
{
    ...
    public static partial class BoolModelExtensions
    {
            ...
            {
                HttpOperationResponse<bool?> result = await operations.GetTrueWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutTrueWithOperationResponseAsync(boolBody, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<bool?> result = await operations.GetFalseWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PutFalseWithOperationResponseAsync(boolBody, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<bool?> result = await operations.GetNullWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<bool?> result = await operations.GetInvalidWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
