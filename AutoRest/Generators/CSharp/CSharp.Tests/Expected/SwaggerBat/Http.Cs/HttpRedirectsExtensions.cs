namespace Fixtures.SwaggerBatHttp
{
    ...
    public static partial class HttpRedirectsExtensions
    {
            ...
            {
                await operations.Head300WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<IList<string>> result = await operations.Get300WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.Head301WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get301WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Put301WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Head302WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get302WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Patch302WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Post303WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Head307WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get307WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Put307WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Patch307WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Post307WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Delete307WithOperationResponseAsync(booleanValue, null, cancellationToken).ConfigureAwait(false);
            }
