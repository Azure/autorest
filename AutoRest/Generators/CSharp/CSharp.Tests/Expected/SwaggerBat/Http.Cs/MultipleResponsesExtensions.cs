namespace Fixtures.SwaggerBatHttp
{
    ...
    public static partial class MultipleResponsesExtensions
    {
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model204NoModelDefaultError200ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model204NoModelDefaultError204ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model204NoModelDefaultError201InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model204NoModelDefaultError202NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model204NoModelDefaultError400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model201ModelDefaultError200ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model201ModelDefaultError201ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200Model201ModelDefaultError400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<object> result = await operations.Get200ModelA201ModelC404ModelDDefaultError200ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<object> result = await operations.Get200ModelA201ModelC404ModelDDefaultError201ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<object> result = await operations.Get200ModelA201ModelC404ModelDDefaultError404ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<object> result = await operations.Get200ModelA201ModelC404ModelDDefaultError400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.Get202None204NoneDefaultError202NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultError204NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultError400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultNone202InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultNone204NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultNone400NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.Get202None204NoneDefaultNone400InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.GetDefaultModelA200ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.GetDefaultModelA200NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.GetDefaultModelA400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.GetDefaultModelA400NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.GetDefaultNone200InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetDefaultNone200NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetDefaultNone400InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetDefaultNone400NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA200NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA200ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA200InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA400NoneWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA400ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA400InvalidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<A> result = await operations.Get200ModelA202ValidWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
