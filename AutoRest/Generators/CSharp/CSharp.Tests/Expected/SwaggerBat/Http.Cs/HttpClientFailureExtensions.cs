namespace Fixtures.SwaggerBatHttp
{
    ...
    public static partial class HttpClientFailureExtensions
    {
            ...
            {
                HttpOperationResponse<Error> result = await operations.Head400WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get400WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Put400WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Patch400WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Post400WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Delete400WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Head401WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get402WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get403WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Put404WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Patch405WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Post406WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Delete407WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Put409WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Head410WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get411WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get412WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Put413WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Patch414WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Post415WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Get416WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Delete417WithOperationResponseAsync(booleanValue, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Error> result = await operations.Head429WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
