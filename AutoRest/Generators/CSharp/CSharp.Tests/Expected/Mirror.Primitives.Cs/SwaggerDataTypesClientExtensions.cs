namespace Fixtures.MirrorPrimitives
{
    ...
    public static partial class SwaggerDataTypesClientExtensions
    {
            ...
            {
                HttpOperationResponse<Product> result = await operations.GetProductWithOperationResponseAsync(responseCode, product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Product> result = await operations.PutProductWithOperationResponseAsync(responseCode, product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Product> result = await operations.PostProductWithOperationResponseAsync(responseCode, product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                HttpOperationResponse<Product> result = await operations.PatchProductWithOperationResponseAsync(responseCode, product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
