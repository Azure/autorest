namespace Fixtures.Azure.SwaggerBatHead
{
    ...
    public static partial class HttpSuccessOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<bool?> result = await operations.Head204WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<bool?> result = await operations.Head404WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
