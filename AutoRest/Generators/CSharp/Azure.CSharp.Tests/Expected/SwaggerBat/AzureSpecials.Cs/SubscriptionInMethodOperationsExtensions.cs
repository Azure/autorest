namespace Fixtures.Azure.SwaggerBatAzureSpecials
{
    ...
    public static partial class SubscriptionInMethodOperationsExtensions
    {
            ...
            {
                await operations.PostMethodLocalValidWithOperationResponseAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostMethodLocalNullWithOperationResponseAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostPathLocalValidWithOperationResponseAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostSwaggerLocalValidWithOperationResponseAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false);
            }
