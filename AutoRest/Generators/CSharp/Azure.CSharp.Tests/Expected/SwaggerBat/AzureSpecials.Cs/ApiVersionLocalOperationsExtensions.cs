namespace Fixtures.Azure.SwaggerBatAzureSpecials
{
    ...
    public static partial class ApiVersionLocalOperationsExtensions
    {
            ...
            {
                await operations.GetMethodLocalValidWithOperationResponseAsync(apiVersion, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetMethodLocalNullWithOperationResponseAsync(apiVersion, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetPathLocalValidWithOperationResponseAsync(apiVersion, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.GetSwaggerLocalValidWithOperationResponseAsync(apiVersion, null, cancellationToken).ConfigureAwait(false);
            }
