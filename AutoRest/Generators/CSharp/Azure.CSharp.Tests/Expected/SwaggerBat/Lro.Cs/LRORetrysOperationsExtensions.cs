namespace Fixtures.Azure.SwaggerBatLro
{
    ...
    public static partial class LRORetrysOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetRetry201CreatingSucceeded200PollingWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutAsyncRelativeRetrySucceededWithOperationResponseAsync(product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutAsyncRelativeRetrySucceededWithOperationResponseAsync(product, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetAsyncRelativeRetrySucceededWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.Delete202Retry200WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDelete202Retry200WithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncRelativeRetrySucceededWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncRelativeRetrySucceededWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostAsyncRelativeRetrySucceededWithOperationResponseAsync(product, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginPostAsyncRelativeRetrySucceededWithOperationResponseAsync(product, cancellationToken).ConfigureAwait(false);
            }
