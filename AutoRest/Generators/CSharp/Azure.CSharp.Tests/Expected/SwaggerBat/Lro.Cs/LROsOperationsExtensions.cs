namespace Fixtures.Azure.SwaggerBatLro
{
    ...
    public static partial class LROsOperationsExtensions
    {
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put200SucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut200SucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put200SucceededNoStateWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut200SucceededNoStateWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Get200SucceededNoStateWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put202Retry200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut202Retry200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetPut202Retry200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put200UpdatingSucceeded204WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut200UpdatingSucceeded204WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Get200CreatingSucceeded200PollWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put201CreatingFailed200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut201CreatingFailed200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Get201CreatingFailed200PollingWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Put200Acceptedcanceled200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPut200Acceptedcanceled200WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Get200Acceptedcanceled200PollWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutNoHeaderInRetryWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutNoHeaderInRetryWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetPutNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutAsyncNoRetrySucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutAsyncNoRetrySucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetAsyncNoRetrySucceededWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutAsyncRetryFailedWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutAsyncRetryFailedWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetAsyncRetryFailedWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutAsyncNoRetrycanceledWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutAsyncNoRetrycanceledWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetAsyncNoRetrycanceledWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.PutAsyncNoHeaderInRetryWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPutAsyncNoHeaderInRetryWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.GetPutAsyncNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.PutNonResourceWithOperationResponseAsync(sku, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.BeginPutNonResourceWithOperationResponseAsync(sku, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.GetNonResourceWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.PutAsyncNonResourceWithOperationResponseAsync(sku, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.BeginPutAsyncNonResourceWithOperationResponseAsync(sku, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.GetAsyncNonResourceWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.PutSubResourceWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.BeginPutSubResourceWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.GetSubResourceWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.PutAsyncSubResourceWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.BeginPutAsyncSubResourceWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<SubProduct> result = await operations.GetAsyncSubResourceWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.DeleteProvisioning202DeletingFailed200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginDeleteProvisioning202DeletingFailed200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.DeleteProvisioning202Deletingcanceled200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginDeleteProvisioning202Deletingcanceled200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Delete202Retry200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginDelete202Retry200WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Delete202NoRetry204WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginDelete202NoRetry204WithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.DeleteNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncNoHeaderInRetryWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncRetrySucceededWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncRetrySucceededWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncNoRetrySucceededWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncNoRetrySucceededWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncRetryFailedWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncRetryFailedWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.DeleteAsyncRetrycanceledWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginDeleteAsyncRetrycanceledWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.Post200WithPayloadWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Sku> result = await operations.BeginPost200WithPayloadWithOperationResponseAsync(null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.Post202NoRetry204WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                AzureOperationResponse<Product> result = await operations.BeginPost202NoRetry204WithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
                return result.Body;
            }
            ...
            {
                await operations.PostAsyncNoRetrySucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginPostAsyncNoRetrySucceededWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostAsyncRetryFailedWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginPostAsyncRetryFailedWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.PostAsyncRetrycanceledWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
            ...
            {
                await operations.BeginPostAsyncRetrycanceledWithOperationResponseAsync(product, null, cancellationToken).ConfigureAwait(false);
            }
