...
public final class AutoRestHeadTestServiceImpl extends AzureServiceClient {
    ...
    public HttpSuccessInner httpSuccess() {
        return new HttpSuccessInner(retrofit, this);
    }
     ...
     */
    public AutoRestHeadTestServiceImpl(String baseUrl, ServiceClientCredentials credentials, OkHttpClient.Builder clientBuilder, Retrofit.Builder retrofitBuilder) {
