...
/**
 * The SubProductImpl model.
 */
@JsonFlatten
public class SubProductImpl extends SubResource {
    /**
     ...
     * @return the SubProductImpl object itself.
     */
    public SubProductImpl setProvisioningState(String provisioningState) {
