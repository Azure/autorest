...
public final class AutoRestPagingTestServiceImpl extends AzureServiceClient implements AutoRestPagingTestService {
     ...
     */
    public AutoRestPagingTestServiceImpl(String baseUri, ServiceClientCredentials credentials, OkHttpClient.Builder clientBuilder, Retrofit.Builder retrofitBuilder) {
