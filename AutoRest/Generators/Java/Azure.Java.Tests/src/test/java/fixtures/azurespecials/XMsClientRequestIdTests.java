...
public class XMsClientRequestIdTests {
    ...
    public void get() throws Exception {
        ...
        ServiceResponse<Void> response = client.xMsClientRequestId().get();
    ...
    public void paramGet() throws Exception {
        ...
        ServiceResponse<Void> response = client.xMsClientRequestId().paramGet("9C4D50EE-2D56-4CD3-8152-34347DC9F2B0");
        Assert.assertEquals(200, response.getResponse().code());
    }
}
