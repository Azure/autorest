 ...
 *
 * @param {Integer} value Send a post request with header values 1 or -2
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
HeaderOperations.prototype.paramInteger = function (scenario, value, options, callback) {
  ...
  try {
    ...
    if (value === null || value === undefined || typeof value !== 'integer') {
      throw new Error('value cannot be null or undefined and it must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {String} scenario Send a post request with header values "scenario": "positive" or "negative"
 *
 * @param {Long} value Send a post request with header values 105 or -2
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
HeaderOperations.prototype.paramLong = function (scenario, value, options, callback) {
  ...
  try {
    ...
    if (value === null || value === undefined || typeof value !== 'long') {
      throw new Error('value cannot be null or undefined and it must be of type long.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {String} scenario Send a post request with header values "scenario": "positive" or "negative"
 *
 * @param {Double} value Send a post request with header values 0.07 or -3.0
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
HeaderOperations.prototype.paramFloat = function (scenario, value, options, callback) {
  ...
  try {
    ...
    if (value === null || value === undefined || typeof value !== 'double') {
      throw new Error('value cannot be null or undefined and it must be of type double.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {String} scenario Send a post request with header values "scenario": "positive" or "negative"
 *
 * @param {Double} value Send a post request with header values 7e120 or -3.0
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 * @returns {Stream} The Response stream
 */
HeaderOperations.prototype.paramString = function (scenario, value, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 * @returns {Stream} The Response stream
 */
HeaderOperations.prototype.paramEnum = function (scenario, value, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
