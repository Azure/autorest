 ...
 * @param {Integer} [intQuery] '1000000' integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Queries.prototype.getIntOneMillion = function (intQuery, options, callback) {
  ...
  // Validate
  try {
    if (intQuery !== null && intQuery !== undefined && typeof intQuery !== 'integer') {
      throw new Error('intQuery must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Integer} [intQuery] null integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 * @param {Long} [longQuery] '10000000000' 64 bit integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Queries.prototype.getTenBillion = function (longQuery, options, callback) {
  ...
  // Validate
  try {
    if (longQuery !== null && longQuery !== undefined && typeof longQuery !== 'long') {
      throw new Error('longQuery must be of type long.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Long} [longQuery] null 64 bit integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 * @param {Double} [floatQuery] '1.034E+20'numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Queries.prototype.floatScientificPositive = function (floatQuery, options, callback) {
  ...
  // Validate
  try {
    if (floatQuery !== null && floatQuery !== undefined && typeof floatQuery !== 'double') {
      throw new Error('floatQuery must be of type double.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Double} [floatQuery] null numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 * @param {Double} [doubleQuery] '9999999.999'numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Queries.prototype.doubleDecimalPositive = function (doubleQuery, options, callback) {
  ...
  // Validate
  try {
    if (doubleQuery !== null && doubleQuery !== undefined && typeof doubleQuery !== 'double') {
      throw new Error('doubleQuery must be of type double.');
    }
  } catch (error) {
    return callback(error);
  }
...
/**
 * Get null numeric value (no query parameter)
 * @param {Double} [doubleQuery] null numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
