...
Implicit.prototype.getOptionalGlobalQuery = function (options, callback) {
  ...
  // Validate
  try {
    if (this.client.optionalGlobalQuery !== null && this.client.optionalGlobalQuery !== undefined && typeof this.client.optionalGlobalQuery !== 'integer') {
      throw new Error('this.client.optionalGlobalQuery must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
