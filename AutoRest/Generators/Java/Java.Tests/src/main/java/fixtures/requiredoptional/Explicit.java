...
Explicit.prototype.postRequiredIntegerParameter = function (bodyParameter, options, callback) {
  ...
  // Validate
  try {
    if (bodyParameter === null || bodyParameter === undefined || typeof bodyParameter !== 'integer') {
      throw new Error('bodyParameter cannot be null or undefined and it must be of type integer.');
    }
  } catch (error) {
...
Explicit.prototype.postOptionalIntegerParameter = function (bodyParameter, options, callback) {
  ...
  try {
    if (bodyParameter !== null && bodyParameter !== undefined && typeof bodyParameter !== 'integer') {
      throw new Error('bodyParameter must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 *
 * @param {Integer} [bodyParameter.value] 
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Explicit.prototype.postRequiredIntegerHeader = function (headerParameter, options, callback) {
  ...
  // Validate
  try {
    if (headerParameter === null || headerParameter === undefined || typeof headerParameter !== 'integer') {
      throw new Error('headerParameter cannot be null or undefined and it must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
...
Explicit.prototype.postOptionalIntegerHeader = function (headerParameter, options, callback) {
  ...
  try {
    if (headerParameter !== null && headerParameter !== undefined && typeof headerParameter !== 'integer') {
      throw new Error('headerParameter must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 *
 * @param {Integer} [bodyParameter.id] 
 *
 ...
 *
 * @param {Integer} [bodyParameter.value.id] 
 *
