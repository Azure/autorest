 ...
 *
 * @param {Integer} [complexBody.field1] 
 *
 * @param {Integer} [complexBody.field2] 
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 *
 * @param {Long} [complexBody.field1] 
 *
 * @param {Long} [complexBody.field2] 
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 *
 * @param {Double} [complexBody.field1] 
 *
 * @param {Double} [complexBody.field2] 
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
 ...
 * @param {Double} [complexBody.field1] 
 *
 * @param {Double} [complexBody.field56ZerosAfterTheDotAndNegativeZeroBeforeDotAndThisIsALongFieldNameOnPurpose] 
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
