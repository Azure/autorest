...
public final class AutoRestDateTestServiceImpl extends ServiceClient implements AutoRestDateTestService {
    ...
    /**
     * Gets the DatesOperations object to access its operations.
     * @return the DatesOperations object.
     */
    public DatesOperations dates() {
        return new DatesOperationsImpl(this.retrofitBuilder.client(clientBuilder.build()).build(), this);
    }
     ...
     */
    public AutoRestDateTestServiceImpl(String baseUrl, OkHttpClient.Builder clientBuilder, Retrofit.Builder retrofitBuilder) {
