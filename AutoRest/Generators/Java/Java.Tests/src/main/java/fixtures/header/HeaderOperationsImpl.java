...
public final class HeaderOperationsImpl implements HeaderOperations {
    ...
    interface HeaderService {
        ...
        Call<ResponseBody> paramDatetimeRfc1123(@Header("scenario") String scenario, @Header("value") String value);
    ...
    public ServiceResponse<Void> paramDate(String scenario, LocalDate value) throws ErrorException, IOException, IllegalArgumentException {
        ...
        String valueConverted = this.client.getMapperAdapter().serializeRaw(value);
        Call<ResponseBody> call = service.paramDate(scenario, valueConverted);
    ...
    public ServiceResponse<Void> paramDatetime(String scenario, DateTime value) throws ErrorException, IOException, IllegalArgumentException {
        ...
        String valueConverted = this.client.getMapperAdapter().serializeRaw(value);
        Call<ResponseBody> call = service.paramDatetime(scenario, valueConverted);
    ...
    public ServiceResponse<Void> paramEnum(String scenario) throws ErrorException, IOException, IllegalArgumentException {
        ...
        String valueConverted = this.client.getMapperAdapter().serializeRaw(value);
        Call<ResponseBody> call = service.paramEnum(scenario, valueConverted);
