...
Dictionary.prototype.putIntegerValid = function (arrayBody, options, callback) {
  ...
  try {
    ...
    for(var valueElement in arrayBody) {
      if (arrayBody[valueElement] !== null && arrayBody[valueElement] !== undefined && typeof arrayBody[valueElement] !== 'integer') {
        throw new Error('arrayBody[valueElement] must be of type integer.');
      }
    }
  } catch (error) {
    return callback(error);
...
Dictionary.prototype.putLongValid = function (arrayBody, options, callback) {
  ...
  try {
    ...
    for(var valueElement in arrayBody) {
      if (arrayBody[valueElement] !== null && arrayBody[valueElement] !== undefined && typeof arrayBody[valueElement] !== 'long') {
        throw new Error('arrayBody[valueElement] must be of type long.');
      }
    }
  } catch (error) {
    return callback(error);
...
Dictionary.prototype.putFloatValid = function (arrayBody, options, callback) {
  ...
  try {
    ...
    for(var valueElement in arrayBody) {
      if (arrayBody[valueElement] !== null && arrayBody[valueElement] !== undefined && typeof arrayBody[valueElement] !== 'double') {
        throw new Error('arrayBody[valueElement] must be of type double.');
      }
    }
  } catch (error) {
    return callback(error);
