 ...
 * Initializes a new instance of the EnumOperations class.
 * @constructor
 *
 * @param {AutoRestSwaggerBATService} client Reference to the service client.
 */
function EnumOperations(client) {
  this.client = client;
}
 ...
 */
EnumOperations.prototype.getNotExpandable = function (options, callback) {
 ...
 * @returns {Stream} The Response stream
 */
EnumOperations.prototype.putNotExpandable = function (stringBody, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
