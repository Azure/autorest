 ...
 * @param {Integer} intPath '1000000' integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Paths.prototype.getIntOneMillion = function (intPath, options, callback) {
  ...
  // Validate
  try {
    if (intPath === null || intPath === undefined || typeof intPath !== 'integer') {
      throw new Error('intPath cannot be null or undefined and it must be of type integer.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Long} longPath '10000000000' 64 bit integer value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Paths.prototype.getTenBillion = function (longPath, options, callback) {
  ...
  // Validate
  try {
    if (longPath === null || longPath === undefined || typeof longPath !== 'long') {
      throw new Error('longPath cannot be null or undefined and it must be of type long.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Double} floatPath '1.034E+20'numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Paths.prototype.floatScientificPositive = function (floatPath, options, callback) {
  ...
  // Validate
  try {
    if (floatPath === null || floatPath === undefined || typeof floatPath !== 'double') {
      throw new Error('floatPath cannot be null or undefined and it must be of type double.');
    }
  } catch (error) {
    return callback(error);
  }
 ...
 * @param {Double} doublePath '9999999.999'numeric value
 *
 * @param {object} [options]
 *
 * @param {object} [options.customHeaders] headers that will be added to
...
Paths.prototype.doubleDecimalPositive = function (doublePath, options, callback) {
  ...
  // Validate
  try {
    if (doublePath === null || doublePath === undefined || typeof doublePath !== 'double') {
      throw new Error('doublePath cannot be null or undefined and it must be of type double.');
    }
  } catch (error) {
    return callback(error);
  }
