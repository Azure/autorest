 ...
 */
ArrayOperations.prototype.getValid = function (options, callback) {
 ...
 * @returns {Stream} The Response stream
 */
ArrayOperations.prototype.putValid = function (complexBody, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 * @returns {Stream} The Response stream
 */
ArrayOperations.prototype.putEmpty = function (complexBody, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 * @returns {Stream} The Response stream
 */
ArrayOperations.prototype.getNotProvided = function (options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
