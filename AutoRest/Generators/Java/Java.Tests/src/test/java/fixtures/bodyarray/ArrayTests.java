...
public class ArrayTests {
    ...
    public void getNull() throws Exception {
        Assert.assertNull(client.array().getNull().getBody());
    }

    @Test
    public void getInvalid() throws Exception {
        try {
            List<Integer> result = client.array().getInvalid().getBody();
    ...
    public void getEmpty() throws Exception {
        List<Integer> result = client.array().getEmpty().getBody();
        Assert.assertEquals(0, result.size());
    }

    @Test
    public void putEmpty() throws Exception {
        client.array().putEmpty(new ArrayList<String>());
    }

    @Test
    public void getBooleanTfft() throws Exception {
        List<Boolean> result = client.array().getBooleanTfft().getBody();
    ...
    public void putBooleanTfft() throws Exception {
        client.array().putBooleanTfft(Arrays.asList(true, false, false, true));
    }

    @Test
    public void getBooleanInvalidNull() throws Exception {
        try {
            List<Boolean> result = client.array().getBooleanInvalidNull().getBody();
    ...
    public void getBooleanInvalidString() throws Exception {
        try {
            List<Boolean> result = client.array().getBooleanInvalidString().getBody();
    ...
    public void getIntegerValid() throws Exception {
        List<Integer> result = client.array().getIntegerValid().getBody();
    ...
    public void putIntegerValid() throws Exception {
        client.array().putIntegerValid(Arrays.asList(1, -1, 3, 300));
    }

    @Test
    public void getIntInvalidNull() throws Exception {
        try {
            List<Integer> result = client.array().getIntInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getIntInvalidString() throws Exception {
        try {
            List<Integer> result = client.array().getIntInvalidString().getBody();
        } catch (InvalidFormatException ex) {
            // expected
    ...
    public void getLongValid() throws Exception {
        List<Long> result = client.array().getLongValid().getBody();
    ...
    public void putLongValid() throws Exception {
        client.array().putLongValid(Arrays.asList(1L, -1L, 3L, 300L));
    }

    @Test
    public void getLongInvalidNull() throws Exception {
        try {
            List<Long> result = client.array().getLongInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getLongInvalidString() throws Exception {
        try {
            List<Long> result = client.array().getLongInvalidString().getBody();
        } catch (InvalidFormatException ex) {
            // expected
    ...
    public void getFloatValid() throws Exception {
        List<Double> result = client.array().getFloatValid().getBody();
    ...
    public void putFloatValid() throws Exception {
        client.array().putFloatValid(Arrays.asList(0d, -0.01d, -1.2e20d));
    }

    @Test
    public void getFloatInvalidNull() throws Exception {
        try {
            List<Double> result = client.array().getFloatInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getFloatInvalidString() throws Exception {
        try {
            List<Double> result = client.array().getFloatInvalidString().getBody();
        } catch (InvalidFormatException ex) {
            // expected
    ...
    public void getDoubleValid() throws Exception {
        List<Double> result = client.array().getDoubleValid().getBody();
        Object[] expected = new Double[] {0d, -0.01, -1.2e20};
        Assert.assertArrayEquals(expected, result.toArray());
    }
    ...
    public void putDoubleValid() throws Exception {
        client.array().putDoubleValid(Arrays.asList(0d, -0.01d, -1.2e20d));
    }

    @Test
    public void getDoubleInvalidNull() throws Exception {
        try {
            List<Double> result = client.array().getDoubleInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getDoubleInvalidString() throws Exception {
        try {
            List<Double> result = client.array().getDoubleInvalidString().getBody();
        } catch (InvalidFormatException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("not a valid Double value"));
        }
    ...
    public void getStringValid() throws Exception {
        List<String> result = client.array().getStringValid().getBody();
    ...
    public void putStringValid() throws Exception {
        client.array().putStringValid(Arrays.asList("foo1", "foo2", "foo3"));
    }

    @Test
    public void getStringWithNull() throws Exception {
        try {
            List<String> result = client.array().getStringWithNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getStringWithInvalid() throws Exception {
        try {
            List<String> result = client.array().getStringWithInvalid().getBody();
        } catch (ErrorException ex) {
            // expected
    ...
    public void getUuidValid() throws Exception {
        List<UUID> result = client.array().getUuidValid().getBody();
    ...
    public void putUuidValid() throws Exception {
        client.array().putUuidValid(Arrays.asList(UUID.fromString("6dcc7237-45fe-45c4-8a6b-3a8a3f625652"),
    ...
    public void getUuidInvalidChars() throws Exception {
        try {
            List<UUID> result = client.array().getUuidInvalidChars().getBody();
            Assert.fail();
        } catch (InvalidFormatException ex) {
            // expected
    ...
    public void getDateValid() throws Exception {
        List<LocalDate> result = client.array().getDateValid().getBody();
    ...
    public void putDateValid() throws Exception {
        client.array().putDateValid(Arrays.asList(
                new LocalDate(2000, 12, 1),
                new LocalDate(1980, 1, 2),
                new LocalDate(1492, 10, 12)
        ));
    ...
    public void getDateInvalidNull() throws Exception {
        try {
            List<LocalDate> result = client.array().getDateInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getDateInvalidString() throws Exception {
        try {
            List<LocalDate> result = client.array().getDateInvalidChars().getBody();
    ...
    public void getDateTimeValid() throws Exception {
        List<DateTime> result = client.array().getDateTimeValid().getBody();
    ...
    public void putDateTimeValid() throws Exception {
        client.array().putDateTimeValid(Arrays.asList(
                new DateTime(2000, 12, 1, 0, 0, 1, DateTimeZone.UTC),
                new DateTime(1980, 1, 2, 0, 11, 35, DateTimeZone.UTC),
                new DateTime(1492, 10, 12, 10, 15, 1, DateTimeZone.UTC)
        ));
    ...
    public void getDateTimeInvalidNull() throws Exception {
        try {
            List<DateTime> result = client.array().getDateTimeInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getDateTimeInvalidString() throws Exception {
        try {
            List<DateTime> result = client.array().getDateTimeInvalidChars().getBody();
        } catch (JsonMappingException ex) {
            // expected
    ...
    public void getDateTimeRfc1123Valid() throws Exception {
        List<DateTime> result = client.array().getDateTimeRfc1123Valid().getBody();
        Object[] expected = new DateTime[] {
                new DateTime(2000, 12, 1, 0, 0, 1, DateTimeZone.UTC),
                new DateTime(1980, 1, 2, 0, 11, 35, DateTimeZone.UTC),
                new DateTime(1492, 10, 12, 10, 15, 1, DateTimeZone.UTC)
    ...
    public void putDateTimeRfc1123Valid() throws Exception {
        client.array().putDateTimeRfc1123Valid(Arrays.asList(
                new DateTime(2000, 12, 1, 0, 0, 1, DateTimeZone.UTC),
                new DateTime(1980, 1, 2, 0, 11, 35, DateTimeZone.UTC),
                new DateTime(1492, 10, 12, 10, 15, 1, DateTimeZone.UTC)
        ));
    ...
    public void getDurationValid() throws Exception {
        List<Period> result = client.array().getDurationValid().getBody();
    ...
    public void putDurationValid() throws Exception {
        client.array().putDurationValid(Arrays.asList(
                        new Period(0, 0, 0, 123, 22, 14, 12, 11),
                        new Period(0, 0, 0, 5, 1, 0, 0, 0)));
    }
    ...
    public void getByteValid() throws Exception {
        List<byte[]> result = client.array().getByteValid().getBody();
    ...
    public void putByteValid() throws Exception {
        client.array().putByteValid(Arrays.asList(
                new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFA},
                new byte[] {(byte) 0x01, (byte) 0x02, (byte) 0x03},
                new byte[] {(byte) 0x25, (byte) 0x29, (byte) 0x43}
        ));
    ...
    public void getByteInvalidNull() throws Exception {
        try {
            List<byte[]> result = client.array().getByteInvalidNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getComplexNull() throws Exception {
        try {
            List<Product> result = client.array().getComplexNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getComplexEmpty() throws Exception {
        List<Product> result = client.array().getComplexEmpty().getBody();
        Assert.assertEquals(0, result.size());
    }

    @Test
    public void getComplexItemNull() throws Exception {
        List<Product> result = client.array().getComplexItemNull().getBody();
    ...
    public void getComplexItemEmpty() throws Exception {
        List<Product> result = client.array().getComplexItemEmpty().getBody();
        Assert.assertEquals(3, result.size());
    ...
    public void getComplexValid() throws Exception {
        List<Product> result = client.array().getComplexValid().getBody();
        Assert.assertEquals(3, result.size());
    ...
    public void putComplexValid() throws Exception {
        ...
        body.add(p3);
        client.array().putComplexValid(body);
    }

    @Test
    public void getArrayNull() throws Exception {
        try {
            List<List<String>> result = client.array().getArrayNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getArrayEmpty() throws Exception {
        List<List<String>> result = client.array().getArrayEmpty().getBody();
        Assert.assertEquals(0, result.size());
    }

    @Test
    public void getArrayItemNull() throws Exception {
        List<List<String>> result = client.array().getArrayItemNull().getBody();
        Assert.assertEquals(3, result.size());
        Assert.assertNull(result.get(1));
    }
    ...
    public void getArrayItemEmpty() throws Exception {
        List<List<String>> result = client.array().getArrayItemEmpty().getBody();
        Assert.assertEquals(3, result.size());
    ...
    public void getArrayValid() throws Exception {
        List<List<String>> result = client.array().getArrayValid().getBody();
    ...
    public void putArrayValid() throws Exception {
        ...
        client.array().putArrayValid(body);
    }

    @Test
    public void getDictionaryNull() throws Exception {
        try {
            List<Map<String, String>> result = client.array().getDictionaryNull().getBody();
        } catch (ErrorException ex) {
            // expected
            Assert.assertTrue(ex.getMessage().contains("JsonMappingException"));
        }
    ...
    public void getDictionaryEmpty() throws Exception {
        List<Map<String, String>> result = client.array().getDictionaryEmpty().getBody();
        Assert.assertEquals(0, result.size());
    }

    @Test
    public void getDictionaryItemNull() throws Exception {
        List<Map<String, String>> result = client.array().getDictionaryItemNull().getBody();
        Assert.assertEquals(3, result.size());
        Assert.assertNull(result.get(1));
    }
    ...
    public void getDictionaryItemEmpty() throws Exception {
        List<Map<String, String>> result = client.array().getDictionaryItemEmpty().getBody();
        Assert.assertEquals(3, result.size());
        Assert.assertEquals(0, result.get(1).size());
    }
    ...
    public void getDictionaryValid() throws Exception {
        List<Map<String, String>> result = client.array().getDictionaryValid().getBody();
    ...
    public void putDictionaryValid() throws Exception {
        ...
        m3.put("9", "nine");
        body.add(m3);
        client.array().putDictionaryValid(body);
    }
}
