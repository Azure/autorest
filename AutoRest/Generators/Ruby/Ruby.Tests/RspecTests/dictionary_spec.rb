...
describe Dictionary do
  ...
  it 'should get boolean tfft' do
    result = @dictionary_client.get_boolean_tfft().value!
    expect(result.response.status).to eq(200)
  ...
  it 'should get integer valid' do
    result = @dictionary_client.get_integer_valid().value!
    expect(result.response.status).to eq(200)
  ...
  it 'should get long valid' do
    result = @dictionary_client.get_long_valid().value!
    expect(result.response.status).to eq(200)
    expect(result.body).to eq(@dict_int)
  end
  ...
  it 'should get date valid' do
    result = @dictionary_client.get_date_valid().value!
    expect(result.response.status).to eq(200)
  ...
  it 'should get byte valid' do
    result = @dictionary_client.get_byte_valid().value!
    expect(result.response.status).to eq(200)
  ...
  it 'should get complex null' do
    result = @dictionary_client.get_complex_null().value!
    expect(result.response.status).to eq(200)
    expect(result.body).to be_nil
  end
  ...
  it 'should get array null' do
    result = @dictionary_client.get_array_null().value!
    expect(result.response.status).to eq(200)
    expect(result.body).to be_nil
  end
  ...
  it 'should get dictionary null' do
    result = @dictionary_client.get_dictionary_null().value!
    expect(result.response.status).to eq(200)
    expect(result.body).to be_nil
  end
