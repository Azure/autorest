...
module ComplexModule
  module Models
    ...
    class Shark < Fish
      ...
      #
      def validate
        fail MsRest::ValidationError, 'property birthday is nil' if @birthday.nil?
      end
      ...
      def self.serialize_object(object)
        ...
        unless object.fishtype.nil? or object.fishtype == "shark"
      ...
      # @return [Shark] Deserialized object.
      #
      def self.deserialize_object(object)
        return if object.nil?
        output_object = Shark.new
