...
module DatetimeRfc1123Module
  ...
  class Datetimerfc1123
    include DatetimeRfc1123Module::Models
    ...
    # @return reference to the AutoRestRFC1123DateTimeTestService
    attr_reader :client
    ...
    def put_utc_max_date_time(datetime_body, custom_headers = nil)
      ...
      datetime_body = datetime_body.new_offset(0).strftime('%a, %d %b %Y %H:%M:%S GMT')
