...
from msrest.exceptions import (
    ...
    ClientRequestError,
    HttpOperationError)
from .operations.parameter_grouping import parameter_grouping
from . import models
...
class AutoRestParameterGroupingTestService(object):
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.parameter_grouping = parameter_grouping(self._client, self.config, self._serialize, self._deserialize)
