    ...
    public class CSharpAzureSwaggerBat : IClassFixture<ServiceController>
    {
        ...
        public void HeadTests()
        {
            SwaggerSpecHelper.RunTests<AzureCSharpCodeGenerator>(
                @"Swagger\SwaggerBat\head.json", @"Expected\SwaggerBat\Head.cs");
        ...
        {
            SwaggerSpecHelper.RunTests<AzureCSharpCodeGenerator>(
                @"Swagger\SwaggerBat\lro.json", @"Expected\SwaggerBat\Lro.cs");
        ...
        {
            SwaggerSpecHelper.RunTests<AzureCSharpCodeGenerator>(
                @"Swagger\SwaggerBat\paging.json", @"Expected\SwaggerBat\Paging.cs");
        ...
        {
            SwaggerSpecHelper.RunTests<AzureCSharpCodeGenerator>(
                @"Swagger\SwaggerBat\azure-report.json", @"Expected\SwaggerBat\Report.Cs");
            var client =
        ...
        {
            SwaggerSpecHelper.RunTests<AzureCSharpCodeGenerator>(
                @"Swagger\SwaggerBat\resource-flattening.json", @"Expected\SwaggerBat\ResourceFlattening.cs");
        }
