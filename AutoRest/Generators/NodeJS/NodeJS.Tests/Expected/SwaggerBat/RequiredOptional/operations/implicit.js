...
Implicit.prototype.getRequiredPath = function (pathParameter, options, callback) {
  ...
  try {
    if (pathParameter === null || pathParameter === undefined) {
      throw new Error('\'pathParameter\' cannot be null');
    }
    if (pathParameter !== null && pathParameter !== undefined && typeof pathParameter !== 'string') {
      throw new Error('pathParameter must be of type string.');
    }
  } catch (error) {
...
Implicit.prototype.putOptionalQuery = function (queryParameter, options, callback) {
  ...
  // Validate
  try {
    if (queryParameter !== null && queryParameter !== undefined && typeof queryParameter !== 'string') {
