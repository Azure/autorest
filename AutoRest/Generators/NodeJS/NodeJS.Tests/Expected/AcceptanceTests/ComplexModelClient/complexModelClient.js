  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse) {
          result = new client._models['CatalogArray'](parsedResponse);
        }
...
ComplexModelClient.prototype.create = function (subscriptionId, resourceGroupName, apiVersion, options, callback) {
  ...
  try {
    if (bodyParameter) {
      requestModel = new client._models['CatalogDictionaryOfArray'](bodyParameter);
    }
  ...
  return client.pipeline(httpRequest, function (err, response, responseBody) {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse) {
          result = new client._models['CatalogDictionary'](parsedResponse);
        }
        if (parsedResponse !== null && parsedResponse !== undefined) {
          result.deserialize(parsedResponse);
        }
...
ComplexModelClient.prototype.update = function (subscriptionId, resourceGroupName, apiVersion, options, callback) {
  ...
  try {
    if (bodyParameter) {
      requestModel = new client._models['CatalogArrayOfDictionary'](bodyParameter);
    }
    if (requestModel !== null && requestModel !== undefined) {
      requestContent = JSON.stringify(requestModel.serialize());
    } else {
