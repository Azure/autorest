 ...
 */
function AutoRestLongRunningOperationTestService(credentials, baseUri, options) {
  ...
  AutoRestLongRunningOperationTestService['super_'].call(this, credentials, options);
