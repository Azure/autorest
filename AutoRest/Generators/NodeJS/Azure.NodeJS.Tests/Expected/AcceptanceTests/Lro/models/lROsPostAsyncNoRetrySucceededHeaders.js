 ...
 * 
 */
function LROsPostAsyncNoRetrySucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LROsPostAsyncNoRetrySucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROsPostAsyncNoRetrySucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsPostAsyncNoRetrySucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROsPostAsyncNoRetrySucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsPostAsyncNoRetrySucceededHeaders;
