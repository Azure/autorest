 ...
 * 
 */
function LROsDelete202NoRetry204Headers(parameters) {
...
/**
 * Validate the payload against the LROsDelete202NoRetry204Headers schema
 *
 * @param {JSON} payload
 *
 */
LROsDelete202NoRetry204Headers.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsDelete202NoRetry204Headers schema
 *
 * @param {JSON} instance
 *
 */
LROsDelete202NoRetry204Headers.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsDelete202NoRetry204Headers;
