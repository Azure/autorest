 ...
 * 
 */
function LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders(parameters) {
...
/**
 * Validate the payload against the LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROSADsPutAsyncRelativeRetryInvalidHeaderHeaders;
