 ...
 * 
 */
function LROsPutAsyncRetryFailedHeaders(parameters) {
...
/**
 * Validate the payload against the LROsPutAsyncRetryFailedHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROsPutAsyncRetryFailedHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsPutAsyncRetryFailedHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROsPutAsyncRetryFailedHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsPutAsyncRetryFailedHeaders;
