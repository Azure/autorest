 ...
 * 
 */
function LROsPostAsyncRetrySucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LROsPostAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROsPostAsyncRetrySucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsPostAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROsPostAsyncRetrySucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsPostAsyncRetrySucceededHeaders;
