 ...
 * 
 */
function LROsDeleteProvisioning202Deletingcanceled200Headers(parameters) {
...
/**
 * Validate the payload against the LROsDeleteProvisioning202Deletingcanceled200Headers schema
 *
 * @param {JSON} payload
 *
 */
LROsDeleteProvisioning202Deletingcanceled200Headers.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsDeleteProvisioning202Deletingcanceled200Headers schema
 *
 * @param {JSON} instance
 *
 */
LROsDeleteProvisioning202Deletingcanceled200Headers.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsDeleteProvisioning202Deletingcanceled200Headers;
