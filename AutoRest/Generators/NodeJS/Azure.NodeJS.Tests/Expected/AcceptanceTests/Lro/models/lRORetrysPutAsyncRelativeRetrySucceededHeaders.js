 ...
 * 
 */
function LRORetrysPutAsyncRelativeRetrySucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LRORetrysPutAsyncRelativeRetrySucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LRORetrysPutAsyncRelativeRetrySucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LRORetrysPutAsyncRelativeRetrySucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LRORetrysPutAsyncRelativeRetrySucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LRORetrysPutAsyncRelativeRetrySucceededHeaders;
