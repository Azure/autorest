 ...
 * 
 */
function LROsCustomHeaderPutAsyncRetrySucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LROsCustomHeaderPutAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROsCustomHeaderPutAsyncRetrySucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsCustomHeaderPutAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROsCustomHeaderPutAsyncRetrySucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsCustomHeaderPutAsyncRetrySucceededHeaders;
