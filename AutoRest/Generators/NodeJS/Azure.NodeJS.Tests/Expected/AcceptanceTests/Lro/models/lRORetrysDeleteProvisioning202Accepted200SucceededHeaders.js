 ...
 * 
 */
function LRORetrysDeleteProvisioning202Accepted200SucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LRORetrysDeleteProvisioning202Accepted200SucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LRORetrysDeleteProvisioning202Accepted200SucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LRORetrysDeleteProvisioning202Accepted200SucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LRORetrysDeleteProvisioning202Accepted200SucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LRORetrysDeleteProvisioning202Accepted200SucceededHeaders;
