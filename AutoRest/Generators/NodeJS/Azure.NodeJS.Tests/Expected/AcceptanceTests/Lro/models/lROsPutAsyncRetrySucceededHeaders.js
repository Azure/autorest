 ...
 * 
 */
function LROsPutAsyncRetrySucceededHeaders(parameters) {
...
/**
 * Validate the payload against the LROsPutAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} payload
 *
 */
LROsPutAsyncRetrySucceededHeaders.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROsPutAsyncRetrySucceededHeaders schema
 *
 * @param {JSON} instance
 *
 */
LROsPutAsyncRetrySucceededHeaders.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROsPutAsyncRetrySucceededHeaders;
