 ...
 * 
 */
function LROSADsPutAsyncRelativeRetry400Headers(parameters) {
...
/**
 * Validate the payload against the LROSADsPutAsyncRelativeRetry400Headers schema
 *
 * @param {JSON} payload
 *
 */
LROSADsPutAsyncRelativeRetry400Headers.prototype.serialize = function () {
  var payload = {};
...
/**
 * Deserialize the instance to LROSADsPutAsyncRelativeRetry400Headers schema
 *
 * @param {JSON} instance
 *
 */
LROSADsPutAsyncRelativeRetry400Headers.prototype.deserialize = function (instance) {
  if (instance) {
...
module.exports = LROSADsPutAsyncRelativeRetry400Headers;
