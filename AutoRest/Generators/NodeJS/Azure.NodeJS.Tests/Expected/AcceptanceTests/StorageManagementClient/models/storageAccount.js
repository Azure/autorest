 ...
 * @constructor
 * The storage account.
 * @member {string} [provisioningState] Gets the status of the storage account at the time the
 * operation was called. Possible values for this property include: 'Creating', 'ResolvingDNS',
 * 'Succeeded'.
 * 
 * @member {string} [accountType] Gets the type of the storage account. Possible values for this
 * property include: 'Standard_LRS', 'Standard_ZRS', 'Standard_GRS', 'Standard_RAGRS',
 * 'Premium_LRS'.
 * 
 * @member {object} [primaryEndpoints] Gets the URLs that are used to perform a retrieval of a
 * public blob, queue or table object.Note that StandardZRS and PremiumLRS accounts only return
 * the blob endpoint.
 * 
 ...
 * 
 * @member {string} [statusOfPrimary] Gets the status indicating whether the primary location of
 * the storage account is available or unavailable. Possible values for this property include:
 * 'Available', 'Unavailable'.
 * 
 * @member {date} [lastGeoFailoverTime] Gets the timestamp of the most recent instance of a
 * failover to the secondary location. Only the most recent timestamp is retained. This element
 * is not returned if there has never been a failover instance. Only available if the accountType
 * is StandardGRS or StandardRAGRS.
 * 
 * @member {string} [secondaryLocation] Gets the location of the geo replicated secondary for the
 * storage account. Only available if the accountType is StandardGRS or StandardRAGRS.
 * 
 * @member {string} [statusOfSecondary] Gets the status indicating whether the secondary location
 * of the storage account is available or unavailable. Only available if the accountType is
 * StandardGRS or StandardRAGRS. Possible values for this property include: 'Available',
 * 'Unavailable'.
 * 
 * @member {date} [creationTime] Gets the creation date and time of the storage account in UTC.
 * 
 * @member {object} [customDomain] Gets the user assigned custom domain assigned to this storage
 * account.
 * 
 * @member {string} [customDomain.name] Gets or sets the custom domain name. Name is the CNAME
 * source.
 * 
 * @member {boolean} [customDomain.useSubDomain] Indicates whether indirect CName validation is
 * enabled. Default value is false. This should only be set on updates
 * 
 * @member {object} [secondaryEndpoints] Gets the URLs that are used to perform a retrieval of a
 * public blob, queue or table object from the secondary location of the storage account. Only
 * available if the accountType is StandardRAGRS.
 * 
