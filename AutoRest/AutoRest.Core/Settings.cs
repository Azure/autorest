...
Changes may cause incorrect behavior and will be lost if the code is regenerated.";
        ...
        public const string MicrosoftApacheLicenseHeader = @"
...
Licensed under the MIT License. See License.txt in the project root for license information.";
        ...
        public string Header
        {
            ...
            set
            {
                ...
                {
                    _header = MicrosoftMitLicenseHeader + Environment.NewLine + DefaultCodeGenerationHeader;
                }
                else if (value == "MICROSOFT_APACHE")
                {
                    _header = MicrosoftApacheLicenseHeader + Environment.NewLine + DefaultCodeGenerationHeader;
                }
                else if (value == "NONE")
                {
