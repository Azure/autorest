        ...
        public IEnumerable<ValidationMessage> ValidationExceptions(Operation entity)
        {
            ...
            */
            ...
            if (entity.Parameters != null)
            {
                ...
                {
                    yield return CreateException(entity.Source, ValidationExceptionName.OnlyOneBodyParameterAllowed, string.Join(",", bodyParameters));
                }
                ...
                foreach (var part in parts.Where(p => !string.IsNullOrEmpty(p)))
                {
                    if (part[0] == '{' && part[part.Length - 1] == '}')
                    {
                        ...
                        {
                            yield return CreateException(entity.Source, ValidationExceptionName.PathParametersMustBeDefined, pName);
                        }
                    }
                }
            }
