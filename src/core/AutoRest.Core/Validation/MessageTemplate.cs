...
namespace AutoRest.Core.Validation
{
    ...
    {
        public static MessageTemplate TestMessage = new MessageTemplate { Id = 666, Message = "This is just a test {0}" };
        ...
        public static MessageTemplate ResponseBodyFormatNoLongerSupported = new MessageTemplate { Id = 1004, Message = "The old version did not support '{0}' as a response body format." };
