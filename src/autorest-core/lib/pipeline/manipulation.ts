...
export class Manipulator {
  ...
  private async ProcessInternal(data: DataHandleRead, scope: DataStoreView, documentId?: string): Promise<DataHandleRead> {
    ...
    if (data.ReadData().length > 6653) {
      if (data.ReadData().length !== 10026)
        console.error("");
      throw null;
    }
    return data;
  }
