...
namespace Microsoft.Perks.Collections {
    using System;
    ...
    public class List<TKey, TValue> : List<KeyValuePair<TKey, TValue>> {
        ...
        public bool Contains(TKey key, TValue value) => IndexOf(key, value) > -1;
    ...
    public class List<T1, T2, T3> : List<Tuple<T1, T2, T3>> {
        ...
        public bool Contains(T1 p1, T2 p2, T3 p3) => Contains(new Tuple<T1, T2, T3>(p1, p2, p3));

        public bool Remove(T1 p1, T2 p2, T3 p3) => Remove(new Tuple<T1, T2, T3>(p1, p2, p3));
    }
    ...
    public class List<T1, T2, T3, T4> : List<Tuple<T1, T2, T3, T4>> {
        ...
        public bool Contains(T1 p1, T2 p2, T3 p3, T4 p4) => Contains(new Tuple<T1, T2, T3, T4>(p1, p2, p3, p4));

        public bool Remove(T1 p1, T2 p2, T3 p3, T4 p4) => Remove(new Tuple<T1, T2, T3, T4>(p1, p2, p3, p4));
    }
    ...
    public class List<T1, T2, T3, T4, T5> : List<Tuple<T1, T2, T3, T4, T5>> {
        ...
        public bool Contains(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5) => Contains(new Tuple<T1, T2, T3, T4, T5>(p1, p2, p3, p4, p5));

        public bool Remove(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5) => Remove(new Tuple<T1, T2, T3, T4, T5>(p1, p2, p3, p4, p5));
    }
}