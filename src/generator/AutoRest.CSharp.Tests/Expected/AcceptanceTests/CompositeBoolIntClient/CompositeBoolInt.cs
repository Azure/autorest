...
namespace Fixtures.AcceptanceTestsCompositeBoolIntClient
{
    ...
    public partial class CompositeBoolInt : ServiceClient<CompositeBoolInt>, ICompositeBoolInt
    {
        ...
        /// </exception>
        public CompositeBoolInt(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public CompositeBoolInt(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
