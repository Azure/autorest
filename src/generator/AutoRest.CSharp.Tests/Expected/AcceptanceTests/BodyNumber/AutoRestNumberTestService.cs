...
namespace Fixtures.AcceptanceTestsBodyNumber
{
    ...
    public partial class AutoRestNumberTestService : ServiceClient<AutoRestNumberTestService>, IAutoRestNumberTestService
    {
        ...
        /// </exception>
        public AutoRestNumberTestService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestNumberTestService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
