...
namespace Fixtures.AcceptanceTestsBodyString
{
    ...
    public partial class AutoRestSwaggerBATService : ServiceClient<AutoRestSwaggerBATService>, IAutoRestSwaggerBATService
    {
        ...
        /// </exception>
        public AutoRestSwaggerBATService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestSwaggerBATService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
