...
namespace Fixtures.AcceptanceTestsHeader
{
    ...
    public partial class AutoRestSwaggerBATHeaderService : ServiceClient<AutoRestSwaggerBATHeaderService>, IAutoRestSwaggerBATHeaderService
    {
        ...
        /// </exception>
        public AutoRestSwaggerBATHeaderService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestSwaggerBATHeaderService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
