...
namespace Fixtures.AcceptanceTestsBodyFormData
{
    ...
    public partial class AutoRestSwaggerBATFormDataService : ServiceClient<AutoRestSwaggerBATFormDataService>, IAutoRestSwaggerBATFormDataService
    {
        ...
        /// </exception>
        public AutoRestSwaggerBATFormDataService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestSwaggerBATFormDataService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
