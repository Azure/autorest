...
namespace Fixtures.AcceptanceTestsBodyFormData
{
    ...
    public partial class AutoRestSwaggerBATFormDataService : Microsoft.Rest.ServiceClient<AutoRestSwaggerBATFormDataService>, IAutoRestSwaggerBATFormDataService
    {
        ...
        /// </exception>
        public AutoRestSwaggerBATFormDataService(System.Uri baseUri, params System.Net.Http.DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestSwaggerBATFormDataService(System.Uri baseUri, System.Net.Http.HttpClientHandler rootHandler, params System.Net.Http.DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
