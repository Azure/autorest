...
namespace Fixtures.AcceptanceTestsBodyArray
{
    ...
    public partial class AutoRestSwaggerBATArrayService : ServiceClient<AutoRestSwaggerBATArrayService>, IAutoRestSwaggerBATArrayService
    {
        ...
        /// </exception>
        public AutoRestSwaggerBATArrayService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestSwaggerBATArrayService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
