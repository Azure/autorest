...
namespace Fixtures.AcceptanceTestsParameterFlattening
{
    ...
    public partial class AutoRestParameterFlattening : ServiceClient<AutoRestParameterFlattening>, IAutoRestParameterFlattening
    {
        ...
        /// </exception>
        public AutoRestParameterFlattening(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestParameterFlattening(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
