...
namespace Fixtures.AcceptanceTestsBodyInteger
{
    ...
    public partial class AutoRestIntegerTestService : ServiceClient<AutoRestIntegerTestService>, IAutoRestIntegerTestService
    {
        ...
        /// </exception>
        public AutoRestIntegerTestService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestIntegerTestService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
