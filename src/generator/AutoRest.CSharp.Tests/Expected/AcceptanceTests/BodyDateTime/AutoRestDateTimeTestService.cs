...
namespace Fixtures.AcceptanceTestsBodyDateTime
{
    ...
    public partial class AutoRestDateTimeTestService : ServiceClient<AutoRestDateTimeTestService>, IAutoRestDateTimeTestService
    {
        ...
        /// </exception>
        public AutoRestDateTimeTestService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestDateTimeTestService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
