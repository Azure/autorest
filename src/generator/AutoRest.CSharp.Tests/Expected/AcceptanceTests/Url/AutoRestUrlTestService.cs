...
namespace Fixtures.AcceptanceTestsUrl
{
    ...
    public partial class AutoRestUrlTestService : ServiceClient<AutoRestUrlTestService>, IAutoRestUrlTestService
    {
        ...
        /// </exception>
        public AutoRestUrlTestService(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AutoRestUrlTestService(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
