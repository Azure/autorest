...
{
    public class CodeGeneratorCsaJsonRpc : CodeGeneratorCsa
    {
        /// <summary>
        ...
        public override async Task Generate(CodeModel cm)
        {
            ...
            foreach (MethodGroupCs group in codeModel.Operations)
            {
                ...
                {
                    // Operation
                    var operationsTemplate = new AutoRest.CSharp.Azure.JsonRpcClient.Templates.AzureMethodGroupTemplate {Model = group};
