...
public interface Paths {
     ...
     */
    ServiceCall<ServiceResponse<Void>> getEmptyAsync(String vault, String secret, String keyName, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
    /**
     * Get a 200 to test a valid base uri.
     *
     * @param vault The vault name, e.g. https://myvault
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Void>> getEmptyAsync(String vault, String secret, String keyName, String keyVersion, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
