...
public interface Inheritances {
     ...
     */
    ServiceCall<ServiceResponse<Siamese>> getValidAsync(final ServiceCallback<Siamese> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Void>> putValidAsync(Siamese complexBody, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
