...
public interface Readonlypropertys {
     ...
     */
    ServiceCall<ServiceResponse<ReadonlyObj>> getValidAsync(final ServiceCallback<ReadonlyObj> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Void>> putValidAsync(ReadonlyObj complexBody, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
