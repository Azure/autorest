...
public interface AvailabilitySets {
     ...
     */
    ServiceCall<ServiceResponse<Void>> updateAsync(String resourceGroupName, String avset, Map<String, String> tags, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
