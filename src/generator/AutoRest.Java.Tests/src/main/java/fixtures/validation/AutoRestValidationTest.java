...
public interface AutoRestValidationTest {
     ...
     */
    ServiceCall<ServiceResponse<Product>> validationOfMethodParametersAsync(String resourceGroupName, int id, final ServiceCallback<Product> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Product>> validationOfBodyAsync(String resourceGroupName, int id, final ServiceCallback<Product> serviceCallback) throws IllegalArgumentException;
    /**
     * Validates body parameters on the method. See swagger for details.
     *
     * @param resourceGroupName Required string between 3 and 10 chars with pattern [a-zA-Z0-9]+.
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Product>> validationOfBodyAsync(String resourceGroupName, int id, Product body, final ServiceCallback<Product> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Void>> getWithConstantInPathAsync(final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Product>> postWithConstantInBodyAsync(final ServiceCallback<Product> serviceCallback) throws IllegalArgumentException;
    /**
     *
     * @param body the Product value
     * @throws ServiceException exception thrown from REST call
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Product>> postWithConstantInBodyAsync(Product body, final ServiceCallback<Product> serviceCallback) throws IllegalArgumentException;
