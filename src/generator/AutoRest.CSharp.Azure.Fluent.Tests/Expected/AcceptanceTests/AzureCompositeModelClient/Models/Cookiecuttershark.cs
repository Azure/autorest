...
namespace Fixtures.AcceptanceTestsAzureCompositeModelClient.Models
{
    ...
    public partial class Cookiecuttershark : Shark
    {
        ...
        /// Initializes a new instance of the Cookiecuttershark class.
        /// </summary>
        public Cookiecuttershark(double length, DateTime birthday, string species = default(string), IList<FishInner> siblings = default(IList<FishInner>), int? age = default(int?))
