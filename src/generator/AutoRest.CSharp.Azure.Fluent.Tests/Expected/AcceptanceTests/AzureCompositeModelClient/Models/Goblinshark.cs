...
namespace Fixtures.AcceptanceTestsAzureCompositeModelClient.Models
{
    ...
    public partial class Goblinshark : Shark
    {
        ...
        /// Initializes a new instance of the Goblinshark class.
        /// </summary>
        public Goblinshark(double length, System.DateTime birthday, string species = default(string), System.Collections.Generic.IList<FishInner> siblings = default(System.Collections.Generic.IList<FishInner>), int? age = default(int?), int? jawsize = default(int?))
