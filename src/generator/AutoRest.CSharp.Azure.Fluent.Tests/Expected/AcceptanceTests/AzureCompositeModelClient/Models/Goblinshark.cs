...
namespace Fixtures.AcceptanceTestsAzureCompositeModelClient.Models
{
    ...
    public partial class Goblinshark : Shark
    {
        ...
        /// Initializes a new instance of the Goblinshark class.
        /// </summary>
        public Goblinshark(double length, DateTime birthday, string species = default(string), IList<FishInner> siblings = default(IList<FishInner>), int? age = default(int?), int? jawsize = default(int?))
