...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROSADsDeleteAsyncRelativeRetry400HeadersInner
    {
        ...
        public LROSADsDeleteAsyncRelativeRetry400HeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
