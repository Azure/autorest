...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    [JsonTransformation]
    public partial class SubProduct : Resource
    {
        /// <summary>
        ...
        /// 'OK'</param>
        public SubProduct(String location = default(String), String id = default(String), String name = default(String), String type = default(String), IDictionary<string, String> tags = default(IDictionary<string, String>), string provisioningState = default(string), string provisioningStateValues = default(string))
