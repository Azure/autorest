...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class Product : Resource
    {
        ...
        /// 'OK'</param>
        public Product(String location = default(String), String id = default(String), String name = default(String), String type = default(String), IDictionary<string, String> tags = default(IDictionary<string, String>), string provisioningState = default(string), string provisioningStateValues = default(string))
