...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeadersInner
    {
        ...
        public LROSADsDeleteAsyncRelativeRetryInvalidHeaderHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
