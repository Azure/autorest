...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner
    {
        ...
        public LROSADsPutAsyncRelativeRetryInvalidHeaderHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
