...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsCustomHeaderPostAsyncRetrySucceededHeadersInner
    {
        ...
        public LROsCustomHeaderPostAsyncRetrySucceededHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
