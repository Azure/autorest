...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsCustomHeaderPutAsyncRetrySucceededHeadersInner
    {
        ...
        public LROsCustomHeaderPutAsyncRetrySucceededHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
