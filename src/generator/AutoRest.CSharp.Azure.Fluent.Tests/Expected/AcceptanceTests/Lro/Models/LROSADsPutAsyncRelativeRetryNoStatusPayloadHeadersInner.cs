...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROSADsPutAsyncRelativeRetryNoStatusPayloadHeadersInner
    {
        ...
        public LROSADsPutAsyncRelativeRetryNoStatusPayloadHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
