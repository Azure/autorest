...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner
    {
        ...
        public LROSADsPutAsyncRelativeRetryInvalidJsonPollingHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
