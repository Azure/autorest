...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LRORetrysPutAsyncRelativeRetrySucceededHeadersInner
    {
        ...
        public LRORetrysPutAsyncRelativeRetrySucceededHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
