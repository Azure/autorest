...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsDeleteAsyncNoRetrySucceededHeadersInner
    {
        ...
        public LROsDeleteAsyncNoRetrySucceededHeadersInner(string azureAsyncOperation = default(string), string location = default(string), int? retryAfter = default(int?))
        {
