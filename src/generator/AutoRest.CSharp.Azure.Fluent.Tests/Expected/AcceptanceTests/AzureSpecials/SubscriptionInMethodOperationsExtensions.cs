...
namespace Fixtures.Azure.AcceptanceTestsAzureSpecials
{
    ...
    public static partial class SubscriptionInMethodOperationsExtensions
    {
            ...
            {
                (await operations.PostMethodLocalValidWithHttpMessagesAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                (await operations.PostMethodLocalNullWithHttpMessagesAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                (await operations.PostPathLocalValidWithHttpMessagesAsync(subscriptionId, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
