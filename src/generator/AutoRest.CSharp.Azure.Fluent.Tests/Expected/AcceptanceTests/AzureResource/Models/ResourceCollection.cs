...
namespace Fixtures.Azure.AcceptanceTestsAzureResource.Models
{
    ...
    public partial class ResourceCollection
    {
        ...
        /// Initializes a new instance of the ResourceCollection class.
        /// </summary>
        public ResourceCollection(FlattenedProductInner productresource = default(FlattenedProductInner), IList<FlattenedProductInner> arrayofresources = default(IList<FlattenedProductInner>), IDictionary<string, FlattenedProductInner> dictionaryofresources = default(IDictionary<string, FlattenedProductInner>))
        {
