...
public interface XMsClientRequestIds {
     ...
     */
    ServiceCall<ServiceResponse<Void>> getAsync(final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
     ...
     * @return the {@link ServiceCall} object
     */
    ServiceCall<ServiceResponse<Void>> paramGetAsync(String xMsClientRequestId, final ServiceCallback<Void> serviceCallback) throws IllegalArgumentException;
