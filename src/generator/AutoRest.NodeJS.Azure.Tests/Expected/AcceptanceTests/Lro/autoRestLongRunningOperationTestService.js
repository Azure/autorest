...
/** Class representing a AutoRestLongRunningOperationTestService. */
class AutoRestLongRunningOperationTestService extends ServiceClient {
  /**
   * Create a AutoRestLongRunningOperationTestService.
