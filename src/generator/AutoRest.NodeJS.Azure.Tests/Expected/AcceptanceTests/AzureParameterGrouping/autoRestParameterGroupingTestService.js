...
/** Class representing a AutoRestParameterGroupingTestService. */
class AutoRestParameterGroupingTestService extends ServiceClient {
  /**
   * Create a AutoRestParameterGroupingTestService.
