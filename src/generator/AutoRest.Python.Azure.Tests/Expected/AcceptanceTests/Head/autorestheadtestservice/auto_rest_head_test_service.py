...
class AutoRestHeadTestService(object):
    ...
    def __init__(
        ...
        self.config = AutoRestHeadTestServiceConfiguration(credentials, accept_language, long_running_operation_retry_timeout, generate_client_request_id, thread_daemon, base_url, filepath)
