...
class AutoRestParameterizedHostTestClientConfiguration(AzureConfiguration):
    ...
    def __init__(
            self, credentials, host, accept_language='en-US', long_running_operation_retry_timeout=30, generate_client_request_id=True, thread_daemon=True, filepath=None):
...
class AutoRestParameterizedHostTestClient(object):
    ...
    def __init__(
        ...
        self.config = AutoRestParameterizedHostTestClientConfiguration(credentials, host, accept_language, long_running_operation_retry_timeout, generate_client_request_id, thread_daemon, filepath)
