...
namespace AutoRest.CSharp.Azure.Fluent
{
    ...
    {
        Task<CodeModelCsaf> ITransformer<CodeModel, CodeModelCsaf>.Transform(CodeModel cs)
        {
        ...
        {
            return await ((ITransformer<CodeModel, CodeModelCsaf>) this).Transform(codeModel);
        }
