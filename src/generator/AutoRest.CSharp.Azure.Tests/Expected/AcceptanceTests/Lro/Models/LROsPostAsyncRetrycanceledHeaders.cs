...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsPostAsyncRetrycanceledHeaders
    {
        ...
        /// LROsPostAsyncRetrycanceledHeaders class.
        /// </summary>
        /// <param name="azureAsyncOperation">Location to poll for result status: will be set to /lro/putasync/retry/canceled/operationResults/200</param>
        /// <param name="location">Location to poll for result status: will be set to /lro/putasync/retry/canceled/operationResults/200</param>
