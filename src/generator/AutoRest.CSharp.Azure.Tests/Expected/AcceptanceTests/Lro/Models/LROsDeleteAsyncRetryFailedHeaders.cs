...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsDeleteAsyncRetryFailedHeaders
    {
        ...
        /// LROsDeleteAsyncRetryFailedHeaders class.
        /// </summary>
        /// <param name="azureAsyncOperation">Location to poll for result status: will be set to /lro/deleteasync/retry/failed/operationResults/200</param>
        /// <param name="location">Location to poll for result status: will be set to /lro/deleteasync/retry/failed/operationResults/200</param>
