...
namespace Fixtures.Azure.AcceptanceTestsLro.Models
{
    ...
    public partial class LROsDeleteAsyncRetrycanceledHeaders
    {
        ...
        /// LROsDeleteAsyncRetrycanceledHeaders class.
        /// </summary>
        /// <param name="azureAsyncOperation">Location to poll for result status: will be set to /lro/deleteasync/retry/canceled/operationResults/200</param>
        /// <param name="location">Location to poll for result status: will be set to /lro/deleteasync/retry/canceled/operationResults/200</param>
