...
{
    public class Bug1264 : BugTest
    {
        public Bug1264(ITestOutputHelper output) : base(output)
        {
        }

        /// <summary>
        ///     https://github.com/Azure/autorest/issues/1264
        ...
        public async Task EmptyPathObjectCodeGenerationTest()
        {
            ...
            using (var fileSystem = GenerateCodeForTestFromSpec())
            {
                ...
                Assert.True(fileSystem.FileExists(@"APIwithcollectionformat.cs"));
