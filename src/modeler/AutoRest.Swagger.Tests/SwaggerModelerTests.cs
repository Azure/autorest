    ...
    public class SwaggerModelerTests
    {
        ...
        public void TestClientModelFromSimpleSwagger()
        {
            using (NewContext)
            {
                ...
                Assert.True(
                    clientModel.Properties.Any(p => p.Name.EqualsIgnoreCase("subscriptionId")));
                Assert.True(
                    clientModel.Properties.Any(p => p.Name.EqualsIgnoreCase("apiVersion")));
                ...
                Assert.Equal("String", clientModel.Methods[0].Parameters[0].ModelType.ToString());
                ...
                Assert.Equal("The product documentation.",
                    clientModel.ModelTypes.First(m => m.Name == "Product").Documentation);
                Assert.Equal("A product id.",
                    clientModel.ModelTypes.First(m => m.Name == "Product").Properties[0].Summary);
                Assert.Equal("product_id", clientModel.ModelTypes.First(m => m.Name == "Product").Properties[0].Name);
                Assert.Equal("product_id",
                    clientModel.ModelTypes.First(m => m.Name == "Product").Properties[0].SerializedName);
        ...
        public void TestExternalReferencesWithReferencesInProperties()
        {
            using (NewContext)
            {
                ...
                Assert.Equal("Product",
                    clientModel.ModelTypes.First(m => m.Name == "ChildProduct").Properties[1].ModelType.Name);
            }
        }
        ...
        public void TestClientModelWithRecursiveTypes()
        {
            using (NewContext)
            {
                ...
                Assert.NotNull(clientModel);
                Assert.Equal("Product", clientModel.ModelTypes.First(m => m.Name == "Product").Name);
                Assert.Equal("ProductId", clientModel.ModelTypes.First(m => m.Name == "Product").Properties[0].Name);
                Assert.Equal("String",
                    clientModel.ModelTypes.First(m => m.Name == "Product").Properties[0].ModelType.ToString());
            }
        }

        [Fact(Skip = "gws - fix equal compare with unimplemented IEnumerable ")]
        public void TestClientModelWithManyAllOfRelationships()
        {
            using (NewContext)
            {
                ...
                var redisResponseWithAccessKeyModel =
                    clientModel.ModelTypes.Single(x => x.Name == "RedisResourceWithAccessKey");
                ...
                var redisCreateUpdateParametersModel =
                    clientModel.ModelTypes.Single(x => x.Name == "RedisCreateOrUpdateParameters");
                ...
                var redisReadablePropertiesWithAccessKeysModel =
                    clientModel.ModelTypes.Single(x => x.Name == "RedisReadablePropertiesWithAccessKey");
        ...
        public void TestClientModelWithNoContent()
        {
            using (NewContext)
            {
                ...
                Assert.True(
                    clientModel.Methods[4].Responses[HttpStatusCode.OK].Body.IsPrimaryType(KnownPrimaryType.Object));
        ...
        public void TestClientModelWithStreamAndByteArray()
        {
            using (NewContext)
            {
                ...
                Assert.Equal("Stream", clientModel.Methods[0].Parameters[0].ModelType.Name);
                ...
                Assert.Equal("ByteArray", clientModel.Methods[1].Parameters[0].ModelType.Name);
        ...
        public void TestDataTypes()
        {
            using (NewContext)
            {
                ...
                var variableEnumInPath =
                    clientModel.Methods.First(m => m.Name == "list" && m.Group == null)
                ...
                var differentEnum =
                    clientModel.Methods.First(m => m.Name == "list" && m.Group == "DiffEnums")
                        .Parameters.First(p => p.Name == "color" && p.Location == ParameterLocation.Query)
                        .ModelType as EnumType;
                ...
                var sameEnum =
                    clientModel.Methods.First(m => m.Name == "get" && m.Group == "SameEnums")
                ...
                var modelEnum =
                    clientModel.ModelTypes.First(m => m.Name == "Product")
        ...
        public void TestClientWithValidation()
        {
            using (NewContext)
            {
                ...
                Assert.Equal("Product", clientModel.ModelTypes.First(m => m.Name == "Product").Name);
                Assert.Equal("DisplayNames", clientModel.ModelTypes.First(m => m.Name == "Product").Properties[2].Name);
        ...
        public void TestConstants()
        {
            using (NewContext)
            {
                ...
                Assert.Equal(true, clientModel.Methods[0].Parameters[4].ModelType.IsPrimaryType(KnownPrimaryType.Int));
                ...
                Assert.Equal(true, clientModel.Methods[0].Parameters[5].ModelType.IsPrimaryType(KnownPrimaryType.String));
                ...
                Assert.Equal(true, clientModel.ModelTypes.First(m => m.Name == "Product").Properties[5].ModelType.IsPrimaryType(KnownPrimaryType.Int));
                ...
                Assert.Equal(true, clientModel.ModelTypes.First(m => m.Name == "Product").Properties[6].ModelType.IsPrimaryType(KnownPrimaryType.String));
                ...
                Assert.Equal(true, clientModel.ModelTypes.First(m => m.Name == "Product").Properties[7].ModelType.IsPrimaryType(KnownPrimaryType.String));
                ...
                Assert.Equal(true, clientModel.ModelTypes.First(m => m.Name == "Product").Properties[8].ModelType.IsPrimaryType(KnownPrimaryType.Int));
                ...
                Assert.Equal("enum", clientModel.ModelTypes.First(m => m.Name == "Product").Properties[9].ModelType.ToString());
                ...
                Assert.Equal(true, clientModel.ModelTypes.First(m => m.Name == "Product").Properties[10].ModelType.IsPrimaryType(KnownPrimaryType.Int));
