...
namespace AutoRest.Swagger.Tests
{
    ...
    public partial class SwaggerModelerValidationTests
    {
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "definition-missing-description.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "definition-contains-msdn-reference.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "default-value-not-in-enum.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "empty-client-name-extension.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "network-interfaces-api.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "anonymous-response-type.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "anonymous-parameter-type.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "operations-invalid-parameters.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "service-def-invalid-parameters.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "operation-group-underscores.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-app-json-operation-consumes.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-app-json-operation-produces.json"));
            messages.AssertOnlyValidationWarning(typeof(NonAppJsonTypeWarning));
        }
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-app-json-service-def-produces.json"));
            messages.AssertOnlyValidationWarning(typeof(NonAppJsonTypeWarning));
        }
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-app-json-service-def-consumes.json"));
            messages.AssertOnlyValidationWarning(typeof(NonAppJsonTypeWarning));
        }
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-https-service-def-scheme.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "non-https-operations-scheme.json"));
            messages.AssertOnlyValidationWarning(typeof(SupportedSchemesWarning));
        }
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "operations-no-responses.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "xms-path-not-in-paths.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "invalid-format.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "swagger-validation.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "nested-properties.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "required-property-not-in-properties.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "operation-missing-description.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "parameter-missing-description.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "pageable-nextlink-not-modeled.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "pageable-no-200-response.json"));
    ...
    public partial class SwaggerModelerValidationTests
    {
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "positive", "clean-complex-spec.json"));
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "positive", "required-property-defined-allof.json"));
            Assert.Empty(messages.Where(m => m.Severity >= Category.Warning));
        }
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Resource","Swagger", "Validation", "positive", "pageable-nextlink-defined-allof.json"));
            Assert.Empty(messages.Where(m => m.Severity >= Category.Warning));
        }
    }
