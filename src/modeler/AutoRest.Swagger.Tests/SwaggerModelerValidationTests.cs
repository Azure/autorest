...
namespace AutoRest.Swagger.Tests
{
    ...
    public partial class SwaggerModelerValidationTests
    {
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Swagger", "Validation", "tracking-resource-patch-operation.json"));
    ...
    public partial class SwaggerModelerValidationTests
    {
        ...
        {
            var messages = ValidateSwagger(Path.Combine("Swagger", "Validation", "positive", "tracking-resource-patch-valid-operation.json"));
