...
* Significantly improved the Ruby code generator by 
  * introducing package version and package name
  * moved request building to clientruntime
  * Improved Error messaging for deserialization and http errors
  * `export AZURE_HTTP_LOGGING=full|partial` to provide http debug logging
...
* Bug fixes in all code generators (#439, #520, #629, #652, #668, #714, #730, #738, #752, #797)
