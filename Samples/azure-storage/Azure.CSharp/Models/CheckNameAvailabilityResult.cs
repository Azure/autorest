...
namespace Petstore.Models
{
    ...
    public partial class CheckNameAvailabilityResult
    {
        ...
        /// <param name="reason">Gets the reason that a storage account name could not be used. The Reason element is only returned if NameAvailable is false. Possible values include: 'AccountNameInvalid', 'AlreadyExists'</param>
