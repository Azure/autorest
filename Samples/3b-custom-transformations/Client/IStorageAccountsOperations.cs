...
namespace
{
    ...
    public partial interface IStorageAccountsOperations
    {
        ...
        /// "$ref": "1"
        /// },
        /// "#documentation": "The name of the storage account within the
        ...
        /// "isNullable": true
        /// },
        /// "description": "Checks that account name is valid and is not in
        /// use.",
        ...
        /// "$ref": "16"
        /// },
        /// "#documentation": "The parameters to provide for the created
        /// account.",
        /// "#name": "parameters",
        ...
        /// the specified parameters. Existing accounts cannot be updated with
        /// this API and should instead use the Update Storage Account API. If
        /// an account is already created and subsequent PUT request is issued
        ...
        /// "isNullable": true
        /// },
        /// "description": "Returns the properties for the specified storage
        /// account including but not limited to name, account type, location,
        /// and account status. The ListKeys operation should be used to
        ...
        /// "$ref": "80"
        /// },
        /// "#documentation": "The parameters to update on the account. Note
        ...
        /// "isNullable": true
        /// },
        /// "description": "Updates the account type or tags for a storage
        /// account. It can also be used to add a custom domain (note that
        /// custom domains cannot be added via the Create operation). Only one
        /// custom domain is supported per storage account. In order to replace
        /// a custom domain, the old value must be cleared before a new value
        /// may be set. To clear a custom domain, simply update the custom
        /// domain with empty string. Then call update again with the new
        /// cutsom domain name. The update API can only be used to update one
        /// of tags, accountType, or customDomain per call. To update multiple
        ...
        /// "isNullable": true
        /// },
        /// "description": "Lists the access keys for the specified storage
        /// account.",
        /// "requestContentType": "application/json; charset=utf-8",
        /// "responseContentTypes": [
        /// "application/json",
        ...
        /// subscription. Note that storage keys are not returned; use the
        ...
        /// },
        /// "description": "Lists all the storage accounts available under the
        /// given resource group. Note that storage keys are not returned; use
        ...
        /// "$ref": "85"
        /// },
        /// "#documentation": "Specifies name of the key which should be
        ...
        /// "isNullable": true
        /// },
        /// "description": "Regenerates the access keys for the specified
        /// storage account.",
        /// "requestContentType": "application/json; charset=utf-8",
        /// "responseContentTypes": [
        /// "application/json",
