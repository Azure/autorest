...
namespace Storage
{
    ...
    /// </summary>
    internal partial class CheckNameAvailabilityOperations : IServiceOperations<StorageManagementClient>, ICheckNameAvailabilityOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal CheckNameAvailabilityOperations(StorageManagementClient client)
        {
            if (client == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<StorageAccount>> GetPropertyWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
