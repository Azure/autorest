...
namespace AwesomeNamespace.Models
{
    ...
    public partial class CheckNameAvailabilityResult
    {
        ...
        /// class.
        /// </summary>
        /// <param name="nameAvailable">Boolean value that indicates whether
        ...
        /// <param name="reason">The reason that a storage account name could
        /// not be used. The Reason element is only returned if NameAvailable
        /// is false. Possible values include: 'AccountNameInvalid',
        /// 'AlreadyExists'</param>
        /// <param name="message">The error message explaining the Reason value
        ...
        /// <summary>
        /// Gets or sets boolean value that indicates whether the name is
        ...
        /// <summary>
        /// Gets or sets the reason that a storage account name could not be
        ...
        /// <summary>
        /// Gets or sets the error message explaining the Reason value in more
        /// detail.
        /// </summary>
