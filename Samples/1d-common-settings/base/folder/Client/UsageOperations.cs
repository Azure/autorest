...
namespace AwesomeNamespace
{
    ...
    public partial class UsageOperations : IServiceOperations<StorageManagementClient>, IUsageOperations
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<UsageListResult>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<UsageListResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<UsageListResult>(_responseContent, Client.DeserializationSettings);
                }
