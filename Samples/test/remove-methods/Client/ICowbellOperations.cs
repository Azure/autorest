...
namespace RemoveMethods
{
    ...
    public partial interface ICowbellOperations
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<Cowbell>> GetWithHttpMessagesAsync(string id = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
