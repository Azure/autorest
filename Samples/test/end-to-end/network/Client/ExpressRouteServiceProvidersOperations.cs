...
namespace applicationGateway
{
    ...
    /// </summary>
    internal partial class ExpressRouteServiceProvidersOperations : IServiceOperations<NetworkClient>, IExpressRouteServiceProvidersOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ExpressRouteServiceProvidersOperations(NetworkClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ExpressRouteServiceProvider>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ExpressRouteServiceProvider>>(_responseContent, Client.DeserializationSettings);
                }
