...
namespace HiddenMethods
{
    ...
    public static partial class CowbellOperationsExtensions
    {
            ...
            /// <param name='body'>
            /// </param>
            internal static void Add(this ICowbellOperations operations, Cowbell body)
            {
            ...
            /// </param>
            internal static async Task AddAsync(this ICowbellOperations operations, Cowbell body, CancellationToken cancellationToken = default(CancellationToken))
            {
