...
namespace SharedHeaders
{
    ...
    public partial interface IApplicationPackageOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse> ActivateWithHttpMessagesAsync(string resourceGroupName, string accountName, string applicationId, string version, ActivateApplicationPackageParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
