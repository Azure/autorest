...
namespace StreamWithContentType
{
    ...
    public partial class Text : IServiceOperations<CowbellModerator>, IText
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> BWithHttpMessagesAsync(Stream text, string contentType, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (text == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "text");
