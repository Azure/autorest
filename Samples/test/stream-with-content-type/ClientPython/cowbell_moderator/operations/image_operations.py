...
class ImageOperations(object):
    ...
    def a(
            self, image, image_content_type=None, custom_headers=None, raw=False, callback=None, **operation_config):
        """
        ...
        :param image_content_type: The content type of the image. Possible
         ...
         'image/tiff'
        :type image_content_type: str or :class:`ContentType
         <streamwithcontenttype.models.ContentType>`
        ...
        if image_content_type is not None:
            header_parameters['Content-Type'] = self._serialize.header("image_content_type", image_content_type, 'ContentType')
