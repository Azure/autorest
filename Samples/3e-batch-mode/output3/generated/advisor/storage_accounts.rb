...
module Advisor
  ...
  class StorageAccounts
    ...
    # @return [TestComposition] reference to the TestComposition
    attr_reader :client
    ...
    def check_name_availability_async(account_name, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Advisor::Models::StorageAccountCheckNameAvailabilityParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Advisor::Models::CheckNameAvailabilityResult.mapper()
    ...
    def create_async(resource_group_name, account_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Advisor::Models::StorageAccountCreateParameters.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Advisor::Models::StorageAccount.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def update_async(resource_group_name, account_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Advisor::Models::StorageAccountUpdateParameters.mapper()
      request_content = @client.serialize(request_mapper,  parameters, 'parameters')
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
    ...
    def list_keys_async(resource_group_name, account_name, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Advisor::Models::StorageAccountKeys.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Advisor::Models::StorageAccountListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def regenerate_key_async(resource_group_name, account_name, regenerate_key, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Advisor::Models::StorageAccountRegenerateKeyParameters.mapper()
