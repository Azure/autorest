...
module Advisor
  ...
  class Suppressions
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = Advisor::Models::SuppressionContract.mapper()
    ...
    def create_async(resource_uri, recommendation_id, name, suppression_contract, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Advisor::Models::SuppressionContract.mapper()
      request_content = @client.serialize(request_mapper,  suppression_contract, 'suppression_contract')
    ...
    def list_async(top = nil, skip_token = nil, custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Advisor::Models::SuppressionContractListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response, 'result.body')
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
