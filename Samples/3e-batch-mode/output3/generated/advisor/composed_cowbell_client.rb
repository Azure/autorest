...
module Advisor
  ...
  #
  class ComposedCowbellClient < MsRest::ServiceClient
    ...
    #
    # Creates initializes a new instance of the ComposedCowbellClient class.
    ...
    #
    def add_telemetry
        sdk_information = 'advisor'
        if defined? Advisor::VERSION
          sdk_information = "#{sdk_information}/#{Advisor::VERSION}"
        end
