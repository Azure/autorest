...
func New()ManagementClient {
    ...
    // FindPetsByStatus multiple status values can be provided with comma seperated
    // strings
    //
    ...
    // GetPetByID returns a pet when ID < 10.  ID > 10 or nonintegers will simulate
    ...
    // to server file is file to upload file will be closed upon successful return.
