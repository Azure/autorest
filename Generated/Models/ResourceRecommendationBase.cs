...
namespace advisor.Models
{
    ...
    public partial class ResourceRecommendationBase
    {
        ...
        /// Initializes a new instance of the ResourceRecommendationBase class.
        /// </summary>
        /// <param name="id">The fully qualified recommendation ID, for example
        /// /subscriptions/subscriptionId/resourceGroups/resourceGroup1/providers/Microsoft.ClassicCompute/virtualMachines/vm1/providers/Microsoft.Advisor/recommendations/recommendationGUID.</param>
        /// <param name="name">The name of recommendation.</param>
        ...
        /// <param name="type">The recommendation type:
        /// Microsoft.Advisor/recommendations.</param>
        public ResourceRecommendationBase(string id = default(string), string name = default(string), string category = default(string), string impact = default(string), string impactedField = default(string), string impactedValue = default(string), System.DateTime? lastUpdated = default(System.DateTime?), IDictionary<string, object> metadata = default(IDictionary<string, object>), string recommendationTypeId = default(string), string risk = default(string), ShortDescription shortDescription = default(ShortDescription), IList<System.Guid?> suppressionIds = default(IList<System.Guid?>), string type = default(string))
        {
            Id = id;
            Name = name;
            Category = category;
        ...
        /// <summary>
        /// Gets or sets the fully qualified recommendation ID, for example
        ...
        /// <summary>
        /// Gets or sets the name of recommendation.
        /// </summary>
        ...
        /// recommendation.
        /// </summary>
        [JsonProperty(PropertyName = "suppressionIds")]
