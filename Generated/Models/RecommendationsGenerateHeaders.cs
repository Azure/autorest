...
namespace advisor.Models
{
    ...
    /// </summary>
    public partial class RecommendationsGenerateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RecommendationsGenerateHeaders
        /// class.
        /// </summary>
        ...
        /// seconds.</param>
        public RecommendationsGenerateHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
