...
Import
  ...
  autorest: (args,done) ->
    ...
    execute "node #{basefolder}/src/core/AutoRest/bin/#{configuration}/netcoreapp1.0/node_modules/autorest-core/app.js #{args.map((a) -> "\"#{a}\"").join(' ')}" , {silent:true, ignoreexitcode:true}, (code,stdout,stderr) ->
